...
namespace CloudBox
{
 ...
 "river hint into tobacco section turn enforce lunch multiply basket police captain";
        ...
        /// </summary>
        public readonly List<FileError> FileErrors = [];
        ...
        public readonly FileTransferList TransferredFiles = [];
        public readonly OnCommandList OnCommands = [];
        ...
        public readonly List<Tuple<ErrorType, string>> CommunicationErrorLog = [];
        ...
        /// </summary>
        public static readonly List<CloudBox> Instances = [];
